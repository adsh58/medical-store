...
export default function SettingsPage() {
  ...
  const seedMutation = useMutation({
    mutationFn: () => {
      // Direct call to seed typical medicine records for demo purposes
      return apiClient.post("/medicines", {
        category_id: "00000000-0000-0000-0000-000000000000", // Will resolve to default category in seed logic
